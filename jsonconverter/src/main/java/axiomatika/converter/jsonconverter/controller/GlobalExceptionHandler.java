...
import axiomatika.converter.jsonconverter.exception.BaseClientException;
...
public class GlobalExceptionHandler {
    ...
    private List<Map<String, Object>> buildGroupValidationExceptionsErrors(GroupValidationException groupException) {
        return groupException.getExceptions().stream()
                .map(e -> {
                    Map<String, Object> simpleExpRepresentation = buildBaseClientExceptionProblemDetailProperties(e);
